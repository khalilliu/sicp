...
(define (install-polynomial-package)
  ...
  (define (negate-terms p)
    (term-map negate-term (term-list p)))
...
;; (polynomial y (3 (polynomial x (101 3) (100 2) (2 4) (0 2))) (2 (polynomial x (100 1) (2 2) (0 1))) (1 (polynomial y (100 1) (2 2) (0 1))) (0 (polynomial x (101 3) (100 1) (2 2) (0 1))))
;; (show (mul pt1 pt3))
...
(show (sub pt3 -pt1))
; (polynomial x (101 3) (100 2) (2 4) (0 2))
(show (sub poly-py1 poly-py1))
; (polynomial y (3 (polynomial x (100 1))) (1 (polynomial y (100 1))) (0 (polynomial x (101 3))))
