...
(define (primitive-procedure-objects)
  (mmap (lambda (proc)(mlist 'primitive (mcadr proc))) primitive-procedures))

(define (setup-environment)
  (let ((initial-env (extend-environment (primitive-procedures-names) 
...
(define (interpret exp)
  (mlist->exp 
    (eval (exp->mlist exp) the-global-environment)))
